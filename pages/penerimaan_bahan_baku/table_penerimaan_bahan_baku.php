			...
			while ($spl = mysqli_fetch_array ($queryspl)){
				...
				echo "
					...
					<tr>
                        ...
                        <td>
                        <a href='index.php?edit_penerimaan_bahan_baku&id_aliran=$spl[id_aliran]'><button type='button' class='btn bg-gradient btn-circle-table waves-effect waves-circle waves-float'; title='Ubah'><i class='material-icons'>create</i></button></a>
...
<div class="modal fade" id="hapus" role="dialog">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <form method="get" action="../controller/penerimaan_bahan_baku/delete.php" class="">
