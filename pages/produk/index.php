            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="card-table">
                    ...
                    if($_SESSION["hak_akses"] == 'kepala produksi'){
                        ...
                        <div class="header">
                            <div class="row clearfix">
                               <a href="index.php?tambah-produk" title="Tambah Data"><button type="button" class="btn bg-gradient btn-circle waves-effect waves-circle waves-float" style="margin-left: 10px;">
