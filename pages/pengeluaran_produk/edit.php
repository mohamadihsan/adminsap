        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card-add">
                    ...
                    <div class="body">
                        <div class="row clearfix">
                            <form action="../controller/pengeluaran_produk/edit.php" id="sign_in" method="POST">
    	                        ...
    	                        <div class="col-md-12">
    	                            ...
    	                            <a href="index.php?pengeluaran_produk" class="btn btn-lg bg-gradient-red waves-effect">BATAL</a>
    	                        </div>
                            </form>
                        </div>
                    </div>
