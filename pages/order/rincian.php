...
$querypelanggan = mysqli_query($konek, "SELECT * FROM order_penjualan_detail WHERE no_invoice = '$no_invoice'");
...
<section class="content">
    ...
    <div class="invoice-box">
        <table cellpadding="0" cellspacing="0">
            ...
            $querypelanggan = mysqli_query($konek, "SELECT * FROM order_penjualan_detail inner join produk on order_penjualan_detail.nama_produk = produk.id_produk WHERE no_invoice = '$no_invoice' GROUP BY order_penjualan_detail.nama_produk ORDER BY order_penjualan_detail.harga ");
                if($querypelanggan == false){
                 die ("Terjadi Kesalahan : ". mysqli_error($konek));
}
while($data = mysqli_fetch_array($querypelanggan)){
            ...
            $querytotal = mysqli_query($konek, "SELECT sum(harga) as total FROM order_penjualan_detail WHERE no_invoice = '$no_invoice'");
                if($querytotal == false){
                 die ("Terjadi Kesalahan : ". mysqli_error($konek));
}
