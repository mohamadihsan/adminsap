							...
							echo "
								<tr>
									...
									if ($spl['tgl_pembayaran'] == '' ){
							          echo " <td><button class='btn-status bg-gradient-red waves-effect'>BELUM</button></td>";
									}else{
							...
							echo "
									...
									if ($spl['tgl_pembayaran'] == '' ){
							          echo " <td><a href='index.php?verifikasi_persetujuan=true&id_order_penjualan=$spl[id_order_penjualan]'><button class='btn-status bg-grey waves-effect'>RINCIAN</button></a>
							              <a href='../controller/order/konfirmasi_pembayaran.php?id_order_penjualan=$spl[id_order_penjualan]' class='lanjut-link'><button class='btn-status bg-gradient-blue waves-effect'>CONFIRM</button></a></td>";
									}else{
									  echo" <td><a href='index.php?verifikasi_persetujuan=true&id_order_penjualan=$spl[id_order_penjualan]'><button class='btn-status bg-grey waves-effect'>RINCIAN</button></a>
										    </td>";
									};
