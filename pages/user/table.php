		...
		<?php
			...
			while ($spl = mysqli_fetch_array ($queryspl)){
				...
				echo "<td>
							...
							<a href='../controller/user/delete.php?id_user=$spl[id_user]' class='delete-link'><button type='button' class='btn bg-gradient-red btn-circle-table waves-effect waves-circle waves-float'><i class='material-icons'>delete</i></button></a>
						</td>
					</tr>";
			}
		?>
