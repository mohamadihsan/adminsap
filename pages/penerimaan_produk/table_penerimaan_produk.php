			...
			while ($spl = mysqli_fetch_array ($queryspl)){
				...
				echo "
					...
					<tr>
				        ...
				        <td><button type='button' class='btn-status bg-gradient-green waves-effect'>".$spl['status_aliran']."</button></td>
                        <td>
                        <a href='index.php?edit_penerimaan_produk&id_aliran=$spl[id_aliran]'><button type='button' class='btn bg-gradient btn-circle-table waves-effect waves-circle waves-float'; title='Ubah'><i class='material-icons'>create</i></button></a>
...
<div class="modal fade" id="hapus" role="dialog">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <form method="get" action="../controller/penerimaan_produk/delete.php" class="">
